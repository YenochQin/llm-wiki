...
- `.Codex/skills/shared-references/academic-writing.md` — Related Work writing rules
...
### Shared References
- `.Codex/skills/shared-references/academic-writing.md` — Related Work writing rules + de-AI polish
- `.Codex/skills/shared-references/citation-verification.md` — BibTeX fetch and [UNCONFIRMED] protocol
