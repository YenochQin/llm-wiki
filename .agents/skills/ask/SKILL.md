...
1. If the answer surfaces a new assertion: create `wiki/claims/{slug}.md` using the AGENTS.md claim template
...
### Shared References
- `.Codex/skills/shared-references/citation-verification.md` (created in Phase 3)
