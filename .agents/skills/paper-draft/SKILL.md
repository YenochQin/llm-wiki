...
- `.Codex/skills/shared-references/academic-writing.md` — writing standards
...
4. Print to terminal:
   ...
   - [UNCONFIRMED] citations: {count} (resolve before submission)
...
### Shared References
- `.Codex/skills/shared-references/academic-writing.md` — writing standards + de-AI polish rules + figure design
- `.Codex/skills/shared-references/citation-verification.md` — BibTeX fetch workflow + [UNCONFIRMED] protocol
