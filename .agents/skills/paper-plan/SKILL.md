...
- `.Codex/skills/shared-references/academic-writing.md` — writing principles
- `.Codex/skills/shared-references/citation-verification.md` — citation discipline
...
### Shared References
- `.Codex/skills/shared-references/academic-writing.md` — narrative structure and section design principles
- `.Codex/skills/shared-references/citation-verification.md` — citation fetch and verification rules
