...
- [x] **berengut_2025_Precision** (miss 14) — Precision isotope-shift spectroscopy for new physics searches and nuclear insights
- [x] **delzanna_2018_Solar** (miss 12) — Solar UV and X-ray spectral diagnostics
- [x] **cassidy_2016_Rates** (miss 10) — Rates of E1, E2, M1, and M2 transitions in Ni II
- [x] **gamrath_2018_MCDHF** (miss 10) — MCDHF calculations of isotope shifts in neutral antimony
- [x] **liu_2024_Presolar** (miss 10) — Presolar grains as probes of supernova nucleosynthesis
- [x] **ma_2024_Natural** (miss 10) — Natural Orbitals and Targeted Non-Orthogonal Orbital Sets for Atomic Hyperfine Structure Multiconfiguration Calculations
- [x] **bromley_2023_Electronimpact** (miss 9) — Electron-impact Excitation of Pt i–iii: The Importance of Metastables and Collision Processes in Neutron Star Merger and Laboratory Plasmas
