...
description: Use when the user asks which lightly-ingested background or thesis papers deserve deeper processing — ranks a promotion shortlist for upgrading light pages to full /ingest or /reingest.
