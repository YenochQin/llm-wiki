...
- The prepared markdown frontmatter `source` must be portable. For Zotero attachments, write `${Zotero data directory}/storage/<attachment-key>/<file>.pdf`, never a machine-specific absolute path such as `E:\...`, `/Users/...`, or `/home/...`.
