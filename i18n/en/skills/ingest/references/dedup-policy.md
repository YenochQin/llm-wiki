...
```bash
uv run python tools/research_wiki.py find-similar-concept "$WIKI_ROOT" "<candidate title>" --aliases "<a,b,c>"
uv run python tools/research_wiki.py find-similar-claim   "$WIKI_ROOT" "<candidate title>" --tags    "<a,b,c>"
```
